"""Класс для представления автомобиля""" # описание модуля

class Car():
	"""Простая модель автомобиля"""
	def __init__(self,make,model,year):
		"""Инициализирует атрибуты экземпляра-описания автомобиля"""
		self.make = make
		self.model = model
		self.year = year
...
#		Затем инициализирует атбрибуты, специфические для электромобиля
#		"""
